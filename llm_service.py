...
def generate_by_context_and_message(prompt_extended_contexts, contexts, message, temperature):
    ...
    pre_scores = []
    for prompt_context in [None] + prompt_extended_contexts:
        prompt = ""
        if prompt_context:
    ...
    for i in range(MAX_SAMPLE):
        ...
        output_comment = generator_tokenizer.decode(output_tokens, skip_special_tokens=True,
